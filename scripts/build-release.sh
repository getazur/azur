...
function usage()
{
    ...
    echo "and generates the checksum files of the azur tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/azur/azur.git"
CLONE_DIR="$BUILD_DIRECTORY/azur-buildall"
TARGET_DIR="$BUILD_DIRECTORY/azur-releases"
DYNAMIC_RELEASE="azur-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="azur-${TAG_VERSION}-linux-staticboost-CLI"
